...
PyObject *ray_serialize_callback = NULL;
PyObject *ray_deserialize_callback = NULL;
...
static PyObject* register_callbacks(PyObject* self, PyObject* args) {
  ...
  if (PyArg_ParseTuple(args, "OO:register_callbacks", &serialize_callback, &deserialize_callback)) {
    ...
    Py_XDECREF(ray_serialize_callback); // Dispose of old serialization callback
    Py_XDECREF(ray_deserialize_callback); // Dispose of old deserialization callback
    ray_serialize_callback = serialize_callback;
    ray_deserialize_callback = deserialize_callback;
    Py_INCREF(Py_None);
    result = Py_None;
  }
  return result;
